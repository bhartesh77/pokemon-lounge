...
const CompareCard = ({ data1, data2 }) => {
  ...
  if (isMobile())
    return (
      <div>
        <div className="w-[50vw] h-[80vh] bg-purple-900 rounded-lg overflow-hidden shadow-xl overflow-scroll overflow-x-hidden custom-scrollbar">
          <img
          ...
          <div className="px-4 py-4">
            <div className="mb-4">
              ...
              <p className="text-gray-300 text-base">
                ...
                <span
                  className={`${getColor(
                    data1.base_experience,
                    data2.base_experience
                  )}`}
                >
                  {data1.base_experience}
                </span>
            ...
            <div className="flex flex-col justify-between">
              <div className="mr-4">
                <p className="font-semibold mb-1 text-gray-300">
                  ...
                  <span
                    className={`${getColor(
                      data1.abilities.length,
                      data2.abilities.length
                    )}`}
                  >
                    {data1.abilities.length}
                  </span>
              ...
              <div className="mt-4">
                <p className="font-semibold mb-1 text-gray-300 text-left">
                  Moves:{" "}
                  <span
                    className={`${getColor(
                      data1.moves.length,
